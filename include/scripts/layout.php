...
$layout['moderationPostLayout'] =
(
<<<EOD
		  <table class="table">
			<tr><td>Title: %s<a class="Link LButton" href="/markAs/p/%s">Mark As...</a></td></tr>
		  <tr><td><div class="col-8"><pre>Post:<br/><br />%s</pre></div></td></tr>
			<tr><td>Post ID: %s<a class="Link LButton" href="/%s/del/%s">Delete Post</a></td></tr>
			<tr><td>Display Status: %s<a class="Link LButton" href="/%s/del/%s">Hide Post</a><a class="Link LButton" href="/%s/del/%s">Unhide Post</a></td></tr>
		  <tr><td>UserName: %s</td></tr>
		  <tr><td>Rank: %s</td></tr>
		</table>
...
<div class="col-3">
<div class="shadowbar">
Donate today and support the website!
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="5XBHKCURNYYZE">
...
<<<EOD
<div class="shadowbar">
  <form action="/rand/mode/new" method="post">
  <label>
  List Title<br />
  ...
  <input type="submit" name="submit" value="Add List" class="Link LButton" />
  </form>
</div>
EOD
);
...
<<<EOD
<div class="shadowbar">
  <form action="/rand/mode/editList" method="post">
  ...
  <label>
  Names (Comma Separated)<br />
  <input type="text" name="list" value="%s" />
  </label>
  <input type="submit" name="submit" value="Add List" class="Link LButton" />
  </form>
</div>
...
$layout['randomTableBegin'] =
(
<<<EOD
<div class="shadowbar">
	<a href="/rand/mode/new" class="Link LButton">New List</a><a href="/rand/mode/logout" class="Link LButton">Use different PIN</a>
  <table class="table">
    <thead>
      <th>List Name</th>
      <th>List</th>
...
$layout['randomListRow'] =
(
<<<EOD
      <tr><td>%s</td><td>%s</td><td>%s</td></tr>
EOD
);
$layout['randomTableEnd'] =
(
<<<EOD
    </tbody>
  </table>
...
<div class="shadowbar">
  <form action="/rand" method="post">
	<label>
	This will be used for all of your lists, so that you can save and<br />
	manage your lists. If you don't have a PIN already, select the<br />
	option below and we will see if it is available and set it up <br />
	for you. None: Once you've executed all of your lists, your account<br />
	is removed as to save space in the database, however, you can just<br />
	create a new account and make lists just as before.<br />
	<select name="new">
		<option value="ex">Existing User</option>
		<option value="new">New User</option>
	</select>
	</label>
	<label>
		Username
  <input type="text" maxlength="32" name="uname" />
  </label>
	<label>
		PIN
  <input type="text" maxlength="4" name="pin" />
  </label>
  <input type="submit" name="submit" value="Use this PIN" class="Link LButton" />
  </form>
</div>
EOD
);
